...
describe("/api/genres", () => {
  ...
  describe("PUT /", () => {
    ...
    it("should return 404 if the genre with given id not found", async () => {
  ...
  describe("DELETE /",()=>{
    ...
    it("should return 404 if it is a invalid id",async()=>{
      id=1  
      const res=await exec() 
      expect(res.status).toBe(404)
    })
    ...
    it("should return the delete genre",async()=>{
      const res=await exec()
